...
This document describes the security architecture of mcp-metsuke-crunchtools.
...
Report security vulnerabilities using [GitHub's private security advisory](https://github.com/crunchtools/mcp-metsuke/security/advisories/new). This creates a private channel visible only to maintainers.
