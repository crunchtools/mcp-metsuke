...
async def save_output(
    ...
    TTL, which would otherwise block re-fires; if that adopted run vanishes by
    racing its own TTL expiry, this falls through to a direct save. Otherwise a
    fresh, identity-stamped completed run is inserted (direct save).
